	...
	<div class=\"col-md-3 col-sm-6 my-3 my-md-0\">
				<form action=\"index.php\" method=\"POST\">
					<div class=\"card shadow\">
						<div>
							<img src=\"$productimg\" alt=\"img\" class=\"img-fluid card-img-top\">
						</div>
						<div class=\"card-body\">
							...
							<p class=\"card-text\">
								Some quick exemple text to build on the card 
							</p>
							<h5>
							...
							<button type=\"submit\" name=\"add\" class=\"btn btn-danger my-3\">Add to Cart <i class=\"fas fa-shopping-cart\"></i></button>
